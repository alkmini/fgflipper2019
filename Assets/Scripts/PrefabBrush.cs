...
public class PrefabBrush : GridBrushBase
{
    ...
    public override void Paint(GridLayout gridLayout, GameObject brushTarget, Vector3Int position)
    {
        ...
        Transform itemInCell = GetObejctInCell(gridLayout, brushTarget.transform, new Vector3Int(position.x, position.y, zPosition));
        if (itemInCell)
        { return; }
        ...
        { return; }
        //GameObject instance = (GameObject)PrefadUtility.InstantiatePrefab(prefab);
    ...
    private static Transform GetObejctInCell(GridLayout gridLayout, Transform parent, Vector3Int position)
    {
        ...
        //Checks chiild objects position against bounds of tile.
